class Queens
  ...
  def attack?
    white[0] == black[0] || white[1] == black[1] || # same x or y ordinate
    white[0] - black[0] == white[1] - black[1] || # on upsloping diag; delta x == delta y
    white[0] - black[0] == black[1] - white[1] # on downsloping diag; delta x == -(delta y)
  end
end
